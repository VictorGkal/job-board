        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->user()->role === 'employer' ? route('employer.dashboard') : route('candidate.dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'candidate')
                        ...
                        <x-nav-link :href="route('candidate.job-posts.index')" :active="request()->routeIs('candidate.job-posts.*')">
                            {{ __('Browse Jobs') }}
                        </x-nav-link>
